...
<script type="text/javascript">
	...
	$(function(){
		...
		/*$("#tBody input[type='checkbox']").click(function () {
			// 如果列表中的所有checkbox都选中了，则“全选”按钮也选中，否则则不选中
		...
		$("#exportActivityChoiceBtn").click(function () {
			...
			// 发送同步请求
			window.location.href = "workbench/activity/exportCheckedActivitiesByIds.do" + id;
		});
			...
			success: function (data) {
				...
				$(function () {
					$("#demo_pag1").bs_pagination({
						...
						visiblePageLinks:5, // 最多可以显示的页数

						showGoToPage:true, // 是否显示跳转按钮
						showRowsPerPage:true, // 是否显示每页显示条数部分
