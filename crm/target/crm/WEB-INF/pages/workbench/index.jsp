...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='settings/error/to404Page.do';">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">2022&nbsp;张余广个人作品</span></div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="settings/error/to404Page.do"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
						<li class="liClass"><a href="workbench/chart/activity/toActivityIndex.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 市场活动统计图表</a></li>
						<li class="liClass"><a href="workbench/chart/clue/toClueIndex.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 线索统计图表</a></li>
						<li class="liClass"><a href="workbench/chart/customerAndContacts/toCustomerAndContactsIndex.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 客户和联系人统计图表</a></li>
